...
public class AssessmentFresherApi {
    ...
    protected ResponseEntity addAssessmentFresher(
            @Parameter(description = "ID of the Fresher employee", required = true)
            @RequestParam Long employeeId,
            @Parameter(description = "ID of the assessment to assign", required = true)
    ...
    protected ResponseEntity updatePointLanguage(
            @Parameter(description = "ID of the Assessment Fresher to update", required = true)
