...
public class AuthenticationApi {
    ...
    protected ResponseEntity login(@RequestBody AuthenticationReq request) {
        try {
    ...
    protected ResponseEntity introspect(
            @Parameter(description = "Token to be introspected", required = true) @RequestParam String token) {
        try {
            var context = SecurityContextHolder.getContext();
            String uid = context.getAuthentication().getName();
    ...
    protected ResponseEntity logout(
            @Parameter(description = "Token to be invalidated", required = true) @RequestParam String token) {
        try {
            var context = SecurityContextHolder.getContext();
            String uid = context.getAuthentication().getName();
